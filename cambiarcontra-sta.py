...
pwd.send_keys('Muyseguro2')


driver.find_element(By.XPATH,'/html/body/div[1]/div/div[1]/div[1]/div[1]/form/div[3]/button[2]').click()

time.sleep(6)
driver.find_element(By.XPATH,'/html/body/div[1]/div/header/div[2]/div/div[2]/div[1]/span/button/div[1]/span').click()

time.sleep(6)
driver.find_element(By.XPATH,'/html/body/div[1]/div/header/div[2]/div/div[2]/div[1]/span/div[2]/ul/li[1]/a').click()

time.sleep(6)
driver.find_element(By.XPATH,'/html/body/div[1]/div/div[2]/div[2]/div[2]/div[1]/div[3]/button[1]').click()
